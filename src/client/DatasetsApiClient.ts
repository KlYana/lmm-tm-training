...
import { type Dataset, type DatasetDetail, type VaporiseDatasetObject} from './DatasetsApiClient.types';

const DEFAULT_API_KEY = '/api/v1';
...
export async function vaporiseDataset(datasetObject: VaporiseDatasetObject): Promise<DatasetDetail> {
